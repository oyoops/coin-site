...
const MAIN_SLOGAN_P1 = `Ready to add a rock-solid - and highly fashionable - investment to your portfolio? RockWifHat awaits! Rocky, the first rock in world history to don a top hat, and his beautiful wife, Roxanne, promise holders with the long-term sturdiness of ROCK 🪨, the swag and chic of TOP HAT 🎩, ... oh, and AI!`;
