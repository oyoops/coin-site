...
const TOKENOMICS_SECTION_TOTAL_SUPPLY_TITLE = `Total Supply`;
const TOKENOMICS_SECTION_TOTAL_SUPPLY_VALUE = `1 Bil.`;

const TOKENOMICS_SECTION_LOT_1_TITLE = `AI Bot Awards`;
const TOKENOMICS_SECTION_LOT_1_VALUE = `15%`;
...
const TOKENOMICS_SECTION_LOT_4_TITLE = `Liquidity`;
