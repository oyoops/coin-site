...
const TOKENOMICS_SECTION_TOTAL_SUPPLY_TITLE = `Supply`;
const TOKENOMICS_SECTION_TOTAL_SUPPLY_VALUE = `1 Bil.`;

const TOKENOMICS_SECTION_LOT_1_TITLE = `Giveaways`;
const TOKENOMICS_SECTION_LOT_1_VALUE = `12%`;

const TOKENOMICS_SECTION_LOT_2_TITLE = `CEX/Mktg.`;
const TOKENOMICS_SECTION_LOT_2_VALUE = `8%`;

const TOKENOMICS_SECTION_LOT_3_TITLE = `Team`;
const TOKENOMICS_SECTION_LOT_3_VALUE = `10%`;

const TOKENOMICS_SECTION_LOT_4_TITLE = `LP Burn`;
const TOKENOMICS_SECTION_LOT_4_VALUE = `70%`;
