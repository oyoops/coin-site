...
const NAME_FOR_STAKING = `Stake`;
const NAME_FOR_BURNING = `Burn`;
const NAME_FOR_CLAIMING = `Claim`;

const APP_DESC_P1 = `RockWifHat dApp is UNDER CONSTRUCTION! 👷🏼‍♂️`;
const APP_DESC_P2 = `The Phantom/MetaMask wallet connections should work, but there are NO smart contracts tied to these buttons.`;
